	...
	<jsp:include page="nav.jsp"></jsp:include>
		...
		<div class="main">
			...
			<div class="main-content">
				<h3 class="page-title">修改视频</h3>
				<div class="container-fluid col-md-6">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">视频详细修改</h3>
						</div>
						<div class="panel-body">
						<form action="<%=path %>/saveSp" method="post">
							<br>
							<div class="input-group">
							<input type="text" style="display: none;" name="id" value="${msg.id }">
								<span class="input-group-btn">
									<button class="btn btn-primary" type="button">名称</button>
								</span> <input class="form-control" name="name" value="${msg.name }" type="text">
							</div>
                            <br>
                            <div class="input-group">
                                <span class="input-group-btn">
                                    ...
                                    <select class="form-control" style="float: right;width: 91%;"
                                             name="parentid" value="${msg.parentid }">
                            ...
                            <br>
                             <div class="input-group">
                                ...
                                </span> <input class="form-control" name="content" value="${msg.content }"  type="text">
                            ...
                            <div class="input-group">
                                ...
                                </span> <input class="form-control" name="href2" value="${msg.href2 }"  type="text">
                            ...
                            <div class="input-group">
                                ...
                                </span> <input class="form-control" name="href3" value="${msg.href3 }"  type="text">
                                 <span class="input-group-addon">请加上http://</span>
                            </div>
                            <br>
                             <div class="input-group">
                                <span class="input-group-btn">
                                    <button class="btn btn-primary" type="button">安卓下载地址</button>
                                </span> <input class="form-control" name="href4" value="${msg.href4 }"  type="text">
                                 <span class="input-group-addon">请加上http://</span>
                            </div>
                            <br>
                            <div class="input-group">
                                <span class="input-group-btn">
                                    <button class="btn btn-primary" type="button">苹果下载地址</button>
                                </span> <input class="form-control" name="href5" value="${msg.href5 }"  type="text">
                                 <span class="input-group-addon">请加上http://</span>
                            </div>
                            <br>
                             <div class="input-group">
                            ...
                            <div class="input-group">
                                ...
                                </span> <input class="form-control" name="img" value="${msg.img }"  type="text">
