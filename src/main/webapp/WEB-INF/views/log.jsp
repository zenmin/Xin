			...
			<div class="vertical-align-middle">
				<div class="auth-box ">
					<div class="left">
						<div class="content">
							<div class="header">
								<div class="logo text-center">Xin</div>
								<p class="lead">管理员登陆</p>
							</div>
							<form class="form-auth-small" action="login" method="post">
								...
								<div class="form-group">
									<label for="signin-password" class="control-label sr-only">密 码</label>
					...
					<div class="right">
						...
						<div class="content text">
							<h1 class="heading">Now This System</h1>
